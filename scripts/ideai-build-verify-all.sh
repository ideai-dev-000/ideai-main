...
# @location scripts/ideai-build-verify-all.sh
...
node scripts/ideai-build-test-parent-child.mjs
echo ""

echo "2️⃣  Checking Dependencies..."
node scripts/ideai-build.mjs verify --no-ui || true
echo ""
...
node scripts/ideai-build-tracker.mjs web build
echo ""

echo "7️⃣  Generating Build Report..."
node scripts/ideai-build-tracker.mjs web report
echo ""
