 ...
 * 
 * @location scripts/ideai-develop-vercel-link.mjs
 * 
 * Usage:
 *   node scripts/ideai-develop-vercel-link.mjs <app-name>
 * 
 * Example:
...
if (!appName) {
  console.error("Usage: node scripts/ideai-develop-vercel-link.mjs <app-name>");
  process.exit(1);
}
