...
if [ -z "$1" ]; then
  ...
  echo ""
  echo "Usage: ./scripts/sync-vercel-to-github.sh [app-name] [reason]"
  echo ""
  echo "Examples:"
  echo "  ./scripts/sync-vercel-to-github.sh web \"emergency hotfix\""
  echo "  ./scripts/sync-vercel-to-github.sh all \"quick iteration\""
  exit 1
fi
