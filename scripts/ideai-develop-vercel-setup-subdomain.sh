...
# @usage ./scripts/ideai-develop-vercel-setup-subdomain.sh <app-name> <subdomain> <root-domain>
# @example ./scripts/ideai-develop-vercel-setup-subdomain.sh docs docs myui.space
# @location scripts/ideai-develop-vercel-setup-subdomain.sh
