...
const frameworkBadgeClasses: Record<Framework, Record<string, string>> = {
  tailwind: {
    ...
    secondary:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-200",
    outline:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border border-blue-200 text-blue-800 dark:border-blue-800 dark:text-blue-200",
  },
  bootstrap: {
  ...
  material: {
    ...
    outline:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border border-blue-200 text-blue-800",
  },
  chakra: {
    default:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-800",
    secondary:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-800",
    outline:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border border-blue-200 text-blue-800",
  },
  radix: {
    default:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-800 dark:bg-slate-800 dark:text-slate-200",
    secondary:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-200 text-slate-900 dark:bg-slate-700 dark:text-slate-100",
    outline:
      "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border border-slate-300 text-slate-800 dark:border-slate-700 dark:text-slate-200",
  },
  shadcn: {
    default:
    ...
    outline:
      "inline-flex items-center rounded-full border border-slate-200 bg-white px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 border-slate-200 text-slate-900 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50",
  },
};
...
export const IdeAIFrameworkBadge = ({
  ...
  const baseClasses =
    frameworkBadgeClasses[framework]?.[variant] ||
    frameworkBadgeClasses.tailwind.default;
