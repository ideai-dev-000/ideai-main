...
export const frameworkConfigs: Record<Framework, FrameworkConfig> = {
  ...
  material: {
    name: "Material UI",
    cardClasses:
      "bg-white dark:bg-slate-900 rounded-lg shadow-md p-6 border border-slate-200 dark:border-slate-700",
    titleClasses:
      "text-2xl font-medium text-slate-900 dark:text-slate-100 mb-2",
    descriptionClasses: "text-slate-600 dark:text-slate-400 mb-4",
    textClasses: "text-slate-700 dark:text-slate-300",
  },
  chakra: {
  ...
  radix: {
    name: "Radix UI",
    cardClasses:
      "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm p-6",
    titleClasses:
      "text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-2",
    descriptionClasses: "text-slate-600 dark:text-slate-400 mb-4",
    textClasses: "text-slate-700 dark:text-slate-300",
  },
  shadcn: {
    ...
    cardClasses:
      "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm p-6",
    titleClasses:
      "text-2xl font-semibold leading-none tracking-tight text-slate-900 dark:text-slate-100 mb-2",
