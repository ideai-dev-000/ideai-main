/**
 * @fileoverview Comprehensive HTML5 test page component
 * 
 * @module IdeAIHTMLTest
 * @description
 * Shared HTML5 test page component displaying all HTML elements.
 * This component can be used across all IdeaI applications to test
 * CSS styling and ensure visual consistency.
 * 
...
export const IdeAIHTMLTest = () => {
  return (
    <div id="top" role="document">
      {/* Documentation Index Section - Same as /docs page with identical classes */}
      <section className="ideai-content mb-12">
        <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
          <article className="ideai-content__prose">
            ...
            <h2>Reduced Copy</h2>
            <p>Short paragraph. Minimal text. Essential information only.</p>
            <p>Another brief sentence. Concise. Clear.</p>
            <p>Final short line.</p>
          </article>
        </div>
      </section>
  ...
  p q r s t u v w x y z { | } ~ </pre>
      ...
      <section id="embedded">
        ...
        <article id="embedded__bgimages">
          ...
          <div style={{backgroundImage: "url('https://placekitten.com/300/300')", width: "300px", height: "300px"}}></div>
          <footer><p><a href="#top">[Top]</a></p></footer>
        </article>
      ...
      <section id="forms">
        ...
        <form>
          ...
          <fieldset id="forms__checkbox">
            ...
            <ul>
              <li><label htmlFor="checkbox1"><input id="checkbox1" name="checkbox" type="checkbox" defaultChecked readOnly /> Choice A</label></li>
          ...
          <fieldset id="forms__radio">
            ...
            <ul>
              <li><label htmlFor="radio1"><input id="radio1" name="radio" type="radio" defaultChecked readOnly /> Option 1</label></li>
