...
/**
 * @fileoverview Shared database schema for all IdeaI apps
 *
 * @module IdeAIDatabaseSchema
 * @description
 * Centralized database schema used across all IdeaI applications.
 * All apps share the same database and schema for unified authentication
 * and data management.
 */
...
// Integration type - shared across apps
