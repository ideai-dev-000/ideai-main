/**
 * @fileoverview Auth provider utilities for IdeaI User Module
 *
 * @module IdeAIAuthProviders
 * @description
 * Utilities to determine which authentication providers are enabled
 * based on environment variables. Supports email, GitHub, Google, and Vercel.
 *
 * @example
 * ```typescript
 * import { getEnabledAuthProviders } from "@repo/ideai-user/lib/auth-providers";
 *
