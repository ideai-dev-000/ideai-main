...
export default function Home() {
  return (
    <IdeAIPageTemplate
      ...
      headerActions={
        <IdeaIButton appName="v0-prototype">Get Started</IdeaIButton>
      }
    >
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          <div className="p-6 border rounded-lg">
            ...
            <p className="text-muted-foreground">
              This is a minimal Next.js 16 boilerplate that follows IdeaI
              standards. Use it as a starting point for new prototypes in V0.
            </p>
          </div>
