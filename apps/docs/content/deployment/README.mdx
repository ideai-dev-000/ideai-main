...
- **[IdeaI Build Workflow](./ideai-build-workflow.md)** ⭐ - **Complete deployment workflow guide** - Single source of truth
- **[Quick Reference](./QUICK-REFERENCE.md)** - Quick command reference for all deployment types
- **[IdeaI Build Auto-Setup](./ideai-build-auto-setup.md)** - One-click project setup system design

### Getting Started

- **[Next Steps](./DEPLOYMENT-NEXT-STEPS.md)** - ⚠️ Current status and blockers
