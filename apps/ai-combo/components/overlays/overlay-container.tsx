      ...
      {isOpen && (
        <Dialog modal={false} open onOpenChange={() => {}}>
          <DialogPortal forceMount>
            ...
            {/* Dialog container */}
            {/* CRITICAL: Position below header (64px) - use calc to center vertically in remaining space */}
            <motion.div
              animate="visible"
              className="fixed left-1/2 z-[100] w-full max-w-lg -translate-x-1/2 px-4"
              exit="exit"
              initial="hidden"
              style={{
                top: "calc(64px + (100vh - 64px) / 2 - 50%)", // Center in space below header
              }}
