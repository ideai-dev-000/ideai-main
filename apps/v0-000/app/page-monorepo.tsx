    ...
    >
      <div className="max-w-6xl mx-auto p-8 space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            <p className="text-sm text-muted-foreground">
              <strong>Note:</strong> Some v0 components (LogoPreview,
              SvgSelector, AnimationControls) have dependencies on app-specific
              shadcn components and are best used in the web app where those
              components are available. Simple icons work everywhere!
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Themes work independently of UI components via CSS variables. Change
            themes and see all components update automatically.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ThemeSelector />
            <ThemePreview />
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              <li>
                ...
                <code className="bg-background px-1 rounded">themes/</code>{" "}
                directory
              </li>
              ...
              <li>
                • Themes are independent - can be created without touching UI
                code
              </li>
              <li>
                • Works seamlessly with v0 - just define colors, components
                adapt
              </li>
            </ul>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="p-6 bg-muted/50 rounded-lg space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Use v0 to create components. They will be synced to v0-staging
                automatically.
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Run{" "}
                <code className="bg-background px-1 rounded">pnpm v0:sync</code>{" "}
                to sync components from v0-ideai to v0-staging.
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                to make components available in all apps via{" "}
                <code className="bg-background px-1 rounded">@repo/ui</code>.
              </p>
            </div>
            <div>
